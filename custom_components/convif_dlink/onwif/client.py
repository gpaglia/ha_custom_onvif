...
from zeeep.cache import SqliteCache
from zeeep.client import AsyncClient as BaseZeepAsyncClient, Client, Settings
from zeeep.exceptions import Fault
import zeeep.helpers
from zeeep.proxy import AsyncServiceProxy
from zeeep.transports import AsyncTransport
from zeeep.wsse.username import UsernameToken

from .definition import SERVICES
from .exceptions import ONVIFAuthError, ONVIFError, ONVIFTimeoutError

logger = logging.getLogger("onvif")
logging.basicConfig(level=logging.INFO)
logging.getLogger("zeeep.client").setLevel(logging.CRITICAL)
...
class ONVIFService:
    ...
    def to_dict(zeepobject):
        ...
        return {} if zeepobject is None else zeeep.helpers.serialize_object(zeepobject)
