...
from zeeep.exceptions import IncompleteMessage
from zeeep.loader import (
    absolute_location,
    is_relative_path,
    load_external,
    load_external_async,
...
from zeeep.utils import findall_multiple_ns
from zeeep.wsdl import parse
from zeeep.wsdl.definitions import Binding, PortType, Service
from zeeep.xsd import Schema

if typing.TYPE_CHECKING:
    from zeeep.transports import Transport
...
class Definition:
    ...
    def parse_binding(
        ...
        if not getattr(self.wsdl.transport, "binding_classes", None):
            from zeeep.wsdl import bindings
