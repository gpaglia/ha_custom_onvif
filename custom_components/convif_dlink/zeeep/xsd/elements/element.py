...
from zeeep import exceptions
from zeeep.exceptions import UnexpectedElementError
from zeeep.utils import qname_attr
from zeeep.xsd.const import Nil, NotSet, xsi_ns
from zeeep.xsd.context import XmlParserContext
from zeeep.xsd.elements.base import Base
from zeeep.xsd.utils import create_prefixed_name, max_occurs_iter
from zeeep.xsd.valueobjects import CompoundValue
...
class Element(Base):
    ...
    def signature(self, schema=None, standalone=True):
        from zeeep.xsd import ComplexType
