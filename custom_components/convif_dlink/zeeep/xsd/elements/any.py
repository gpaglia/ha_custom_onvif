...
from zeeep.xsd.const import NotSet, xsi_ns
from zeeep.xsd.elements.base import Base
from zeeep.xsd.utils import max_occurs_iter
from zeeep.xsd.valueobjects import AnyObject
...
class Any(Base):
    ...
    def render(self, parent, value, render_path=None):
        ...
        if self.accepts_multiple and isinstance(value, list):
            from zeeep.xsd import AnySimpleType
